...
function Home() {
  ...
  return (
    ...
    <div className="container mt-5 mb-5 d-flex justify-content-between">
      ...
      <Link to={'/history'} style={{textDecoration:'none',color:'white',fontSize:'1.3em'}} >Watch History <i class="fa-solid fa-clock-rotate-left"></i> </Link>
    </div>
    <div className="container-fluid w-100 mtt-5 mb-5 row">
